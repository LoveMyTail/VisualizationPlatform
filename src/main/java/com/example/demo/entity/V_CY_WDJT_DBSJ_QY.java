...
/**
 * 该实体用于展示区域对标部分数据
 * 该数据来自视图 V_CY_WDJT_DBSJ_QY
 * 月度区域五大集团对标数据
 */
public class V_CY_WDJT_DBSJ_QY {
    ...
    public V_CY_WDJT_DBSJ_QY() {
    }

    public V_CY_WDJT_DBSJ_QY(Date YF, String SS_JT, Double DY_LML, Double DY_RCRZ, Double DY_RCBMDJ_HS) {
        this.YF = YF;                       // 月份
        this.SS_JT = SS_JT;                 // 集团名称
        this.DY_LML = DY_LML;               // 来煤量
        this.DY_RCRZ = DY_RCRZ;             // 入厂热值
        this.DY_RCBMDJ_HS = DY_RCBMDJ_HS;   // 含税标单
    }
